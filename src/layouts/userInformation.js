    ...
    <>
      <div className="flex justify-center items-center bg-white rounded-l-lg mb-4 border border-gray-200 shadow w-full sm:w-1/2 lg:1/3 xl:w-1/4">
        <div className="flex flex-col justify-center items-center py-10">
          <img className="w-24 h-24 mb-3 rounded-full shadow-lg object-cover" src={user[0]?.image} alt="Bonnie" />
          <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">{user[0]?.firstName} {user[0]?.lastName}</h5>
      ...
      <div className="bg-white border border-gray-200 rounded-r-lg drop-shadow-lg mb-4 mr-0 xl:mr-5 w-full sm:w-1/2 lg:w-1/2 xl:w-1/3">
        <div className='px-8 py-4'>
          <div className='flex flex-row justify-between items-center'>
            <h2 className='font-bold text-sm lg:text-xl'>User Information</h2>
        ...
        <div className='px-8 py-4'>
          <div className='flex flex-row justify-between items-center my-3'>
            ...
            <span><label className='font-poppins text-gray-400 font-normal'>{new Date(user[0]?.dob).toLocaleDateString()}</label></span>
          </div>
          <div className='flex flex-row justify-between items-center my-3'>
            <span><label className='font-poppins text-gray-400 text-sm font-semibold'>Gender Identity</label></span>
            <span><label className='font-poppins text-gray-400 text-sm font-normal'>{user[0]?.gender}</label></span>
          </div>
          <div className='flex flex-row justify-between items-center my-3'>
            <span><label className='font-poppins text-gray-400 text-sm font-semibold'>Pronouns</label></span>
            <span><label className='font-poppins text-gray-400 text-sm font-normal'>{user[0]?.pronoun}</label></span>
          </div>
          <div className='flex flex-row justify-between items-center my-3'>
            <span><label className='font-poppins text-gray-400 text-sm font-semibold'>Race</label></span>
            <span><label className='font-poppins text-gray-400 text-sm font-normal'>{user[0]?.race}</label></span>
          </div>
          <div className='flex flex-row justify-between items-center my-3'>
            <span><label className='font-poppins text-gray-400 text-sm font-semibold'>Phone Number</label></span>
            <span><label className='font-poppins text-gray-400 text-sm font-normal'>{user[0]?.phoneNo}</label></span>
          </div>
          {/* <div className='flex flex-row justify-between items-center my-3'>
          ...
          <div className='flex flex-row justify-between items-center my-3'>
            ...
            <span><label className='font-poppins text-gray-400 text-sm font-normal'>{user[0]?.zipCode}</label></span>
          </div>
        </div>
      </div>
      {/* <VideoInto /> */}
