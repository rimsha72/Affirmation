...
export default function SupportHeader({ requestName }) {
                ...
                <div className='flex flex-wrap justify-center sm:justify-end'>
                    ...
                    <div className='mb-3'>
                        <button
                            ...
                            className="text-gray-400 w-32 bg-white font-medium rounded-md text-xs px-4 py-2.5 mr-3 text-center inline-flex items-center" type="button">
                            Date
                        </button>
                    ...
                    <div className='mb-3'>
                        <button className="text-gray-400 w-32 bg-white font-medium rounded-md text-xs px-4 mr-3 py-2.5 text-center inline-flex items-center" type="button">
                            Type
                        </button>
                        <div id="dropdown" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                    ...
                    <div>
                        <button className="text-gray-400 w-32 bg-white font-medium rounded-md text-xs px-4 py-2.5 text-center inline-flex items-center" type="button">
                            {requestName}
                        </button>
                        <div id="dropdown" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
